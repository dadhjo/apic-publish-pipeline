...
APIC_INSTANCE=apicon-noprd-01
APIC_ADMIN_URL=`oc -n ${APIC_NAMESPACE} get mgmt ${APIC_INSTANCE}-mgmt -o jsonpath="{.status.zenRoute}" && echo ""`
...
APIC_API_MANAGER_URL=${APIC_ADMIN_URL}
